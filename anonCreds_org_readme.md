...
- Hyperledger AnonCreds code repositories are generally licensed under the [Apache License 2.0](https://www.apache.org/licenses/LICENSE-2.0), unless otherwise noted in a specific repository. Specification work may operate under the Community Specification License v1.0.

<!-- TODO: Add links once confirmed:
- Current community meeting calendar
- Current maintainer list
- LFX Insights page
- Direct project charter link
-->
...
|---|---|---|
| AnonCreds Working Group Meeting | Weekly | _TBD — Add LFX Calendar link_ |
...
Specification work may operate under the [Community Specification License v1.0](https://github.com/anoncreds/anoncreds-spec/blob/main/LICENSE). Please check the `LICENSE`, `NOTICE`, or repository-specific governance files before reusing content.
