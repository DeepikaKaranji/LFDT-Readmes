...
- The [compact repository](https://github.com/LFDT-Minokawa/compact) is the main codebase for the language and tooling.
- The [governance repository](https://github.com/LFDT-Minokawa/governance) contains project governance materials.
- The [Compact documentation](https://docs.midnight.network/compact) provides language and developer documentation.
- Watch Minokawa videos through the [LFDT Minokawa video page](https://www.lfdecentralizedtrust.org/projects/minokawa#videos) and the LFDT YouTube channel.
...
- CONTRIBUTING.md
- GLOBAL-MAINTAINERS.md or MAINTAINERS.md
- SECURITY.md
- Technical charter
...
|---|---|---|
| Minokawa Community Call | TBD | _TBD — Add LFX Calendar link_ |
